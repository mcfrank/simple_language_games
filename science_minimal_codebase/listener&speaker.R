...
source("~/Projects/R/simple_pragmatics/science_final/listener_helper.R")
source("~/Projects/R/simple_pragmatics/science_final/bootstrap_CIs.R")
source("~/Projects/R/simple_pragmatics/science_final/get_speaker.R")

## get listener data
ldata <- read.csv("~/Projects/R/simple_pragmatics/science_final/listener.csv")
ldata <- remove.repeats(ldata)
ldata <- filter.responses.obj(ldata)
ld <- return.sorted.bets(ldata)

## get coordination data
cdata <- read.csv("~/Projects/R/simple_pragmatics/science_final/coordination.csv")
